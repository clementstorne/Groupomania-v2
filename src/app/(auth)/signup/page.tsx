...
const Page = () => {
  return (
    <section className={cn("w-full p-4", "md:p-8")}>
      ...
      >
        <SignupForm className={cn("lg:col-span-3 lg:px-20")} />
        <Image
          src={image}
